...
/**
* Gets the stored user preferences for the GTD system mail address.
 *
 * @return {Object} The user's GTD system mail address, if
 *     it exist.
 */
function getPreferences() {
  var userProperties = PropertiesService.getUserProperties();
  var sendingPrefs = {
    mailAddr: userProperties.getProperty('mailAddr'),
  };
  return sendingPrefs;
}
